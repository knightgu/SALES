...
#' \code{glmnet} package.
#' 
#' The function runs \code{\link{ernet}} \code{nfolds}+1 times; the first to
#' get the \code{lambda} sequence, and the remainder to compute the fit with
#' each of the folds removed. The average error and standard deviation over the
#' folds are computed.
#' 
...
#' \code{NULL}, and \code{\link{ernet}} chooses its own sequence.
...
#' purposes).} \item{ernet.fit}{a fitted \code{\link{ernet}} object for the
