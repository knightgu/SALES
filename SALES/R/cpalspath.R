cpalspath <- function(x, y, w, nlam, flmin, ulam, isd, intr, eps, dfmax, pmax,
                      jd, pfmean, pf2mean, pfscale, pf2scale, maxit, lam2, tau,
                      nobs, nvars, vnames) {
  ##=======================================================================##
  ## DATA SETUP
  ...
  fit <- .Fortran("cpalslassoNET", w, tau, lam2, nobs, nvars, x, y, jd, pfmean,
                  ...
                  nbeta = integer(nlam), t0 = double(nlam),
                  theta = double(pmax * nlam), itheta = integer(pmax),
                  ntheta = integer(nlam), alam = double(nlam),
                  npass = integer(1), jerr = integer(1), PACKAGE = "SALES")
  ##=======================================================================##
  ## OUTPUT
